...
> Puedes seguirme en [GitHub](https://github.com/aastroza) (donde podrás ver todos mis otros proyectos), [Linkedin](https://linkedin.com/in/aastrozacl) y [X](https://twitter.com/aastroza). No olvides sumarte a la [comunidad de IADevs](https://www.linkedin.com/company/iadevsconf).
...
- [Leadeboard de ASR de español chileno](https://huggingface.co/spaces/idsudd/open_asr_leaderboard_cl).
- [Dataset de transcripciones de español chileno](https://huggingface.co/datasets/astroza/es-cl-asr-test-only-full).
- [Herramienta de anotación de audio para ASR](https://github.com/aastroza/fast_audio_annotate).
